...
function NPSCalculator() {
  ...
  const [principalInvested, setPrincipalInvested] = useState(0);
  ...
  useEffect(() => {
    ...
    const principalInvestedValue = monthlyInvestment * monthsToInvest;
    ...
    setPrincipalInvested(principalInvestedValue);
        ...
        <div className="flex md:flex-row flex-col gap-6 md:gap-[74px] text-[15px] lg:text-lg lg:space-x-0 rounded-xl py-4 lg:py-8 p-2 vs:p-6 md:p-6 lg:p-8 border">
          ...
          <div className="w-full lg:w-6/12 space-y-2 sm:space-y-4 md:space-y-8 m-auto">
              ...
              <div className="min-h-10 sm:h-14 md:h-11">
                <div className="flex justify-between items-center">
                  ...
                  <input
                    ...
                    className={`p-2 pl-4 pr-3 border rounded-md shadow-sm w-20 text-right ${
            ...
            <div className="space-y-1 sm:space-y-2 md:space-y-6">
              <div className="min-h-10 sm:h-14 md:h-11">
                <div className="flex justify-between items-center">
                  <label className="font-medium">Annuity Purchase (%)</label>
                  <input
                    type="number"
            ...
            <div className="space-y-1 sm:space-y-2 md:space-y-6">
              <div className="min-h-10 sm:h-14 md:h-11">
                <div className="flex justify-between items-center">
                  <label className="font-medium">Annuity Return (%)</label>
                  <input
                    type="number"
                    value={annuityReturn}
          ...
          <div className="w-full lg:w-6/12 text-[15px] vs:text-[17px] sm:text-[18px] md:text-base lg:text-base m-auto">
            <div className="text-left text-[13px] ws:text-[14px] us:text-lg md:text-base lg:text-lg">
              ...
              <div className="flex items-center mb-2.5">
                <div className="w-3 h-10 us:h-12 md:h-10 lg:h-12 bg-mint"></div>
                <div className="flex flex-col ml-3">
                  <span className="lg:text-base">Principal Invested</span>
                  <span className="font-semibold">
                    ₹{formatChartNumber(principalInvested)}{" "}
                    {formatNumber(principalInvested)
                      ? `(${formatNumber(principalInvested)})`
                      : null}
                  </span>
                </div>
